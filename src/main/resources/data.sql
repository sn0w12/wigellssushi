...
INSERT INTO customer_order (id, customer_id, total_price_sek, total_price_euro) VALUES (1, 1, 200, 20);
INSERT INTO customer_order (id, customer_id, total_price_sek, total_price_euro) VALUES (2, 2, 300, 30);

-- Insert Bookings
INSERT INTO booking (id, customer_id, number_of_guests, date, total_price_sek, total_price_euro, room_id, customer_order_id)
VALUES (1, 1, 10, '2024-06-10', 1000, 100, 1, 1);
INSERT INTO booking (id, customer_id, number_of_guests, date, total_price_sek, total_price_euro, room_id, customer_order_id)
